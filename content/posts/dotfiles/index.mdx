...
One has that problem, for sure another one has the same. Try to find the problem you have then you will find the solution from someone else. And here is my reference that helps me a lot to set up mine [dotfiles.github.io](https://dotfiles.github.io).

#### Then automate them as much as you can!

Here is my dotfiles repo on GitHub [phatpham9/dotfiles](https://github.com/phatpham9/dotfiles). Which contains 3 things:
