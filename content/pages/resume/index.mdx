...
- **Backend**: Node.js (Express.js), <u>Golang</u>, WebSocket (SocketIO), <u>GraphQL</u>, REST, <u>gRPC</u>, Kafka, PostgreSQL, MongoDB, Redis, <u>ElasticSearch</u>, Nginx/<u>Envoy</u>, <u>Ambassador</u>, <u>Istio</u>.
- **DevOps**: Linux, Bash, Docker, Kubernetes, CI/CD (GitHub Actions/GitLab CI), AWS/GCP, <u>Prometheus</u>, <u>Fluentd</u>, <u>Jaeger</u>.
- **Tools**: Git, Yarn, TypeScript, PostCSS, ESLint, Prettier, Webpack, Rollup, Yeoman, <u>Helm</u>, VS Code.
...
- More projects at [/phatpham9](https://github.com/phatpham9), [/boringcodes](https://github.com/boringcodes) & [/gorillab](https://github.com/gorillab).
