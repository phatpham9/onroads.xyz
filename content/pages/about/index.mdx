...
- **2024 to 2026**: Studying M.S. in Computer Science, major in Artificial Intelligence at [Sai Gon University](http://sgu.edu.vn/) Vietnam.
...
- [create-package](https://github.com/boringcode-dev/create-package): TypeScript package/module generator.
- [create-service](https://github.com/boringcode-dev/create-service): TypeScript Express microservice generator.
- [create-service-component](https://github.com/boringcode-dev/create-service-component): Component generator for [create-service](https://github.com/boringcode-dev/create-service).
- [create-dotgithub](https://github.com/boringcode-dev/create-dotgithub): GitHub dotfiles generator.
- More on my GitHub [/phatpham9](https://github.com/phatpham9), [/boringcode-dev](https://github.com/boringcode-dev).

#### AI/ML Contributions

- Explore my AI/ML experiments, models and datasets on [Hugging Face](https://huggingface.co/phatpham9).
