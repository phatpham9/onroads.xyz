...
- **Backend**: Node.js (Express/NestJS), WebSocket, GraphQL, RESTful, Kafka, PostgreSQL, MongoDB, Redis.
- **DevOps**: Bash, Docker, Kubernetes, Terraform, GitHub Actions/Argo Workflows, Argo CD, Nginx, Emissary, Consul, Signoz, AWS/Google Cloud.
